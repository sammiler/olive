 ...
 * 这个类继承自 ProjectSerializer，并实现了针对版本号为 211228 的项目文件的
 * 具体加载逻辑。它与 ProjectSerializer210907 的结构非常相似，
 * 主要区别在于 XMLNodeData 结构体中增加了对节点 UUID 的处理。
 */
class ProjectSerializer211228 : public ProjectSerializer {
 public:
  /**
   * @brief ProjectSerializer211228 默认构造函数。
   */
  ProjectSerializer211228() = default;

 protected:
  /**
   * @brief 实现从 XML 流加载版本号为 211228 的项目数据的具体逻辑。
 ...
 private:
   ...
   *  与 210907 版本相比，新增了 `node_uuids` 成员用于存储节点的 UUID。
   */
  struct XMLNodeData {
...
#endif  // SERIALIZER211228_H // 头文件宏定义结束