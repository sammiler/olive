...
const AudioParams &SampleBuffer::audio_params() const { return audio_params_; }
...
void SampleBuffer::destroy() { data_.clear(); }
...
void SampleBuffer::silence() { silence(0, sample_count_per_channel_); }
